...
<head>
    <meta charset="utf-8">
    <link href="/assets/Compiled/dist/images/logo.svg" rel="shortcut icon">
    ...
    <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                ...
                <span class="text-white text-lg ml-3"> Kasirrrr </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Search -->
            <div class="intro-x relative mr-3 sm:mr-3 ml-6">
            ...
            <div class="intro-x dropdown w-8 h-8">
                <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in scale-110" role="button" aria-expanded="false" data-tw-toggle="dropdown">
                    <img alt="Midone - HTML Admin Template" src="/assets/Compiled/dist/images/profile-5.jpg">
                </div>
...
<form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
    ...
    <nav class="top-nav">
        <ul>
            <li>
                <a href="{{ route('home') }}" wire-navigate class="top-menu {{ request()->routeIs('home') ? 'btn-primary' : 'btn-outline-primary' }}">
            ...
            <li>
                <a href="{{ route('user') }}" wire-navigate
                    class="top-menu {{ request()->routeIs('user') ? 'btn-primary active' : 'btn-outline-primary' }}">
                    <div class="top-menu__icon"> <i data-lucide="users"></i> </div>
                    <div class="top-menu__title"> Users <i class="top-menu__sub-icon"></i> </div>
                </a>
            </li>
            <li>
                <a href="{{ route('transaksi') }}" wire-navigate class="top-menu {{ request()->routeIs('transaksi') ? 'btn-primary' : 'btn-outline-primary' }}">
                    <div class="top-menu__icon"> <i data-lucide="activity"></i> </div>
                    <div class="top-menu__title"> Transaksi <i class="top-menu__sub-icon"></i> </div>
                </a>
            </li>
            <li>
                <a href="{{ route('laporan') }}" wire-navigate class="top-menu {{ request()->routeIs('laporan') ? 'btn-primary' : 'btn-outline-primary' }}">
                    <div class="top-menu__icon"> <i data-lucide="layout"></i> </div>
                    <div class="top-menu__title"> Laporan <i class="top-menu__sub-icon"></i> </div>
                </a>

            </li>
            <li>
                <a href="{{ route('produk') }}" wire-navigate class="top-menu {{ request()->routeIs('produk') ? 'btn-primary' : 'btn-outline-primary' }}">
                    <div class="top-menu__icon"> <i data-lucide="box"></i> </div>
                    <div class="top-menu__title"> Barang <i class="top-menu__susers"></i> </div>
                </a>
            </li>
            <li>
                ...
                <ul class="">
                    ...
                    <li>
                        ...
                        <ul class="">
                            <li>
                                <a href="side-menu-light-wysiwyg-editor-classic.html" class="top-menu">
                                    <div class="top-menu__icon"> <i data-lucide="zap"></i> </div>
                                    <div class="top-menu__title">Classic</div>
                                </a>
                            </li>
                            <li>
                                <a href="side-menu-light-wysiwyg-editor-inline.html" class="top-menu">
                                    <div class="top-menu__icon"> <i data-lucide="zap"></i> </div>
                                    <div class="top-menu__title">Inline</div>
                                </a>
                            </li>
                            <li>
                                <a href="side-menu-light-wysiwyg-editor-balloon.html" class="top-menu">
                                    <div class="top-menu__icon"> <i data-lucide="zap"></i> </div>
                                    <div class="top-menu__title">Balloon</div>
                                </a>
                            </li>
                            <li>
                                <a href="side-menu-light-wysiwyg-editor-balloon-block.html" class="top-menu">
                                    <div class="top-menu__icon"> <i data-lucide="zap"></i> </div>
                                    <div class="top-menu__title">Balloon Block</div>
                                </a>
                            </li>
                            <li>
                                <a href="side-menu-light-wysiwyg-editor-document.html" class="top-menu">
                                    <div class="top-menu__icon"> <i data-lucide="zap"></i> </div>
            ...
            <li>
                <a href="javascript:;" class="top-menu">
                    ...
                    <div class="top-menu__title"> Widgetsss <i data-lucide="chevron-down" class="top-menu__sub-icon"></i> </div>
                </a>
                <ul class="">
                    <li>
    ...
    <div data-url="top-menu-dark-dashboard-overview-1.html" class="dark-mode-switcher cursor-pointer shadow-md fixed bottom-0 right-0 box border rounded-full w-40 h-12 flex items-center justify-center z-50 mb-10 mr-10">
